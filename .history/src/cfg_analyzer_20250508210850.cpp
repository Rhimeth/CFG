...
// Fix the namespace qualification - the function is a member of the CFGAnalyzer class within the CFGAnalyzer namespace
AnalysisResult CFGAnalyzer::CFGAnalyzer::analyzeMultipleFiles(
...
// Fix the namespace qualification for this helper function too
int CFGAnalyzer::CFGAnalyzer::countFunctionCalls(const std::unordered_map<std::string, std::set<std::string>>& dependencies) {
    int count = 0;
