...
clang::ASTContext* Parser::parseFile(const std::string& filePath) {
    ...
    // Use a direct instance instead of thread_local to avoid potential threading issues
    try {
        // Create a new state for each parse operation
...
// Remove the redefinition of ASTStoringConsumer and just implement the Initialize method
