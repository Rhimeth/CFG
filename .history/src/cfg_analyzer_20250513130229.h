...
struct AnalysisResult {
    bool success = false;
    std::string dotOutput = "";  // Initialize with empty string
    std::string jsonOutput = ""; // Initialize with empty string
    std::string report = "";     // Initialize with empty string
    std::unordered_map<std::string, std::set<std::string>> functionDependencies;
    std::map<std::string, FunctionInfo> functions;

    // Add explicit constructor and destructor
    AnalysisResult() = default;
    
    // Add copy constructor to ensure proper deep copies
