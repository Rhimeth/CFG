...
void MainWindow::highlightNodeInCodeEditor(int nodeId) {
    ...
    border.format.setBorderStyle(QTextFormat::BorderStyle_Solid);
    border.format.setBorderBrush(edgeColor);
    border.format.setBorderWidth(4);
    ...
    qDebug() << "Current editor style sheet:" << ui->codeEditor->styleSheet();
    if (!ui->codeEditor->styleSheet().isEmpty()) {
        qDebug() << "Temporarily clearing stylesheet for testing";
