...
void MainWindow::displayGraph(const QString& dotContent) {
    ...
    // Properly expose our methods to JavaScript
    m_webChannel->registerObject("bridge", this);  // Use 'this' directly to access Q_INVOKABLE methods
    webView->page()->setWebChannel(m_webChannel);
...
<body>
    ...
    <script>
        ...
        new QWebChannel(qt.webChannelTransport, function(channel) {
            ...
            console.log("WebChannel ready, methods:", Object.keys(bridge));
            hideLoading();
        });
