...
void MainWindow::onNodeClicked(const QString& nodeId)
{
    ...
    QString dotContent = QString::fromStdString(generateValidDot(m_currentGraph));
    QString progressiveDot = generateProgressiveDot(dotContent, id);
    displayGraph(progressiveDot);
};
