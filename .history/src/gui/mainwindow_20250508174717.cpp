...
void MainWindow::highlightNodeInCodeEditor(int nodeId) {
    ...
    // Left border - Fix incorrect border style methods
    QTextEdit::ExtraSelection border;
    border.format.setProperty(QTextFormat::FrameStyle, QTextFrameFormat::BorderStyle_Solid);
    border.format.setProperty(QTextFormat::FrameBorderBrush, edgeColor);
    border.format.setProperty(QTextFormat::FrameBorderWidth, 4);
