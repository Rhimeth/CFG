...
void MainWindow::setupBasicUI()
{
    ...
    // Fix theme initialization syntax
    m_availableThemes = {
        {"Light", Theme(Qt::white, Qt::black, Qt::black, QColor("#f0f0f0"))},
        {"Dark", Theme(QColor("#333333"), QColor("#cccccc"), Qt::white, QColor("#222222"))},
        {"Blue", Theme(QColor("#e6f3ff"), QColor("#0066cc"), Qt::black, QColor("#f0f7ff"))}
    };
