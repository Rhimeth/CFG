                    ...
                    <script>
                        try {
                            ...
                            viz.renderSVGElement(`%1`)
                                .then(svg => {
                                    document.getElementById('graph-container').appendChild(svg);
                                    // Ensure the graph fits in view and isn't zoomed in
...
QString MainWindow::generateInteractiveDot(std::shared_ptr<GraphGenerator::CFGGraph> graph) {
    ...
    stream << "  nodesep=0.5;\n";
    stream << "  ranksep=0.5;\n";
    stream << "  node [shape=rectangle, style=filled, fillcolor=lightblue, fontname=\"Arial\", fontsize=10];\n";
...
void MainWindow::on_analyzeButton_clicked()
{
    ...
    try {
        ...
        ui->reportTextEdit->clear();
        loadEmptyVisualization(); // Add this line
