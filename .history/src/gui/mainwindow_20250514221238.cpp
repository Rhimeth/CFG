...
void MainWindow::analyzeMultipleFiles()
{
    ...
    for (int i = 0; i < ui->fileListWidget->count(); i++) {
        files.append(ui->fileListWidget->item(i)->data(Qt::UserRole).toString());
    }
    ...
    QtConcurrent::run([this, sourceFiles, &analyzer, &progressDialog]() {
        try {
            auto result = analyzer.analyzeMultipleFiles(
                sourceFiles,
            ...
            QMetaObject::invokeMethod(this, [this, result]() {
                handleMultiFileAnalysisResult(result);
            });
        } catch (const std::exception& e) {
            QMetaObject::invokeMethod(this, [this, e]() {
                QMessageBox::critical(this, "Analysis Error", 
