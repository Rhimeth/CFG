...
private:
    ...
    QList<QTextCursor> m_searchResults;  // Changed from QSet<int>
    ...
    void analyzeSingleFile(const QString& filePath);
    std::string filterDotOutput(const std::string& dotOutput);
};
