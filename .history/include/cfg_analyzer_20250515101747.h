...
namespace CFGAnalyzer {
    ...
    struct AnalysisResult {
        ...
        ~AnalysisResult() {
            assert(dotOutput.c_str() && "Invalid dotOutput string");
            assert(jsonOutput.c_str() && "Invalid jsonOutput string");
            assert(report.c_str() && "Invalid report string");
        }
    };
    ...
    class CFGAnalyzer {
    public:
        // Define the AnalysisResult struct here
        struct AnalysisResult {
            bool success;
            std::string dotOutput;
            std::string report;
            ...
            AnalysisResult(bool success = false, 
                          const std::string& dotOutput = "", 
                          const std::string& report = "")
                : success(success), dotOutput(dotOutput), report(report) {}
        };
