...
public slots:
    ...
    Q_INVOKABLE void handleNodeClick(const QString nodeId) { emit nodeClicked(nodeId); }
    Q_INVOKABLE void handleEdgeClick(const QString fromId, const QString toId) { emit edgeClicked(fromId, toId); }
